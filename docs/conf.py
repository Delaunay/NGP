#!/usr/bin/env python
"""
ngp documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "ngp"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import ngp.core  # noqa
...
project = "ngp"
_full_version = ngp.core.__version__
author = ngp.core.__author__
copyright = ngp.core.__copyright__
